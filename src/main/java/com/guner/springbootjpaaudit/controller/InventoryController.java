...
public class InventoryController {
    ...
    @PostMapping("/updateInventory/{inventoryId}/{inventoryName}")
    public Inventory updateInventory(@PathVariable("inventoryId") int inventoryId, @PathVariable("inventoryName") String inventoryName) {
        return inventoryService.updateInventoryWithCheckTransactional(inventoryId, inventoryName);
    }
